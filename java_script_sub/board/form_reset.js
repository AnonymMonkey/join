...
function resetClassError() {
  Array.from(document.querySelectorAll(".error")).forEach((el) => el.classList.remove("error"));
}
...
function resetRequiredFields() {
  Array.from(document.querySelectorAll(".requiredField")).forEach((el) => el.classList.add("d-none"));
}
