...
async function deleteContactOverlay(ID) {
  openContactOverlay();
  let pos = getIndexOfJson("contact_ID", ID);

  let name = getIndexOfJson("contact_ID", ID)["contact_name"];
  let mail = getIndexOfJson("contact_ID", ID)["contact_mail"];
  let phone = getIndexOfJson("contact_ID", ID)["contact_phone"];
  let initials = getIndexOfJson("contact_ID", ID)["contact_initials"];
  let color = getIndexOfJson("contact_ID", ID)["contact_color"];
